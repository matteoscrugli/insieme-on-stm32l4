 ...
 */
   ...
   */
    ...
    arm_status arm_fully_connected_q7_div(const q7_t * pV,
                                      const q7_t * pM,
                                      const uint16_t dim_vec,
                                      const uint16_t num_of_rows,
                                      const uint16_t bias_shift,
    ...
    arm_status arm_fully_connected_q7_o32( const q7_t * pV,
									   	   const q7_t * pM,
										   const uint16_t dim_vec,
										   const uint16_t num_of_rows,
										   const uint16_t bias_shift,
   ...
   */
    ...
    arm_status arm_fully_connected_q7_opt_div(const q7_t * pV,
                                          const q7_t * pM,
                                          const uint16_t dim_vec,
                                          const uint16_t num_of_rows,
                                          const uint16_t bias_shift,
 ...
 */
   ...
   */
    ...
    void      arm_maxpool_q7_HWC_1D(q7_t * Im_in,
                                 ...
                                 const uint16_t padding,
                                 const uint16_t stride,
                                 const uint16_t dim_im_out/*, q7_t * Im_out*/);
