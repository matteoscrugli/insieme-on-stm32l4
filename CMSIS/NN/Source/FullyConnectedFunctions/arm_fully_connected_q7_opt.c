 ...
 */
 ...
 arm_status
 arm_fully_connected_q7_opt_div(const q7_t * pV,
                            const q7_t * pM,
                            const uint16_t dim_vec,
                            const uint16_t num_of_rows,
                            const uint16_t bias_shift,
                            ...
                            q15_t * vec_buffer)
 {
     ...
     while (rowCnt)
     {
         ...
         *pO++ = (q7_t) (__SSAT((sum / out_div) + 0.5, 8));
         *pO++ = (q7_t) (__SSAT((sum2 / out_div) + 0.5, 8));
         *pO++ = (q7_t) (__SSAT((sum3 / out_div) + 0.5, 8));
         *pO++ = (q7_t) (__SSAT((sum4 / out_div) + 0.5, 8));
     ...
     while (rowCnt)
     {
         ...
         *pO++ = (q7_t) __SSAT((ip_out / out_div) + 0.5, 8);
